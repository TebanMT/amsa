...
func existPurchaseByFolioHandler(ctx context.Context, request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	exist, err := purchaseOrderUseCase.ExistFolio(ctx, idCompany, folio)
	if err != nil {
...
func main() {
	lambda.Start(existPurchaseByFolioHandler)
}
